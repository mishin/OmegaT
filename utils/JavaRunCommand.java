...
public class JavaRunCommand {
    ...
    public static void main(String args[]) {
	    ...
	    // run the Unix "ps -ef" command
			...
			Process p = Runtime.getRuntime().exec('c:\\Share\\Dwimperl\\perl\\bin\\perl.exe c:\\TCPU59\\scripts\\google_trnslate.pl --to ru --from en "Old awk always has a line loop, even if there are no line actions, whereas new awk does not."');
